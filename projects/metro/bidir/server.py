...
from projects.metro.bidir.model import MetroModel
from projects.metro.bidir.model import Walker
from projects.metro.bidir.model import Wall
from projects.metro.bidir.model import Gate
...
leftRate_slider = UserSettableParameter("slider", "Left Rate", 0.15, 0, 0.50, 0.01)
rightRate_slider = UserSettableParameter("slider", "Right Rate", 0.15, 0, 0.50, 0.01)
